...
public class MenuBasedatos extends Frame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == m11) stado.setText("Estado : " + m11.getLabel());
        if(e.getSource() == m12) stado.setText("Estado : " + m12.getLabel());
        if(e.getSource() == m13) stado.setText("Estado : " + m13.getLabel());
        if(e.getSource() == m14) stado.setText("Estado : " + m14.getLabel());
        if(e.getSource() == m21){
            new Coche().setVisible(true);
            stado.setText("Estado : " + m21.getLabel());
        }
        if(e.getSource() == m22) stado.setText("Estado : " + m22.getLabel());
        if(e.getSource() == m23) stado.setText("Estado : " + m23.getLabel());
        if(e.getSource() == m24) stado.setText("Estado : " + m24.getLabel());
        if(e.getSource() == m31) stado.setText("Estado : " + m31.getLabel());
        if(e.getSource() == m41) stado.setText("Estado : " + m41.getLabel());
        if(e.getSource() == m42) stado.setText("Estado : " + m42.getLabel());
